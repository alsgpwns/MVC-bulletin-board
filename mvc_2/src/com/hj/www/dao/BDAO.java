...
public class BDAO{
	...
	private final String INSERT_INTO_SQL="insert into "+TABLE_NAME+" (NAME,TITLE,CONTENTS) values(?,?,?)";
	...
	//insert
	public void writeOKtoDAO(BDTO dto) {
		Connection conn = getConnection();
		PreparedStatement ps = null;
		int curNum=0;
		int rs=0;
		try {
			ps=conn.prepareStatement(INSERT_INTO_SQL);
